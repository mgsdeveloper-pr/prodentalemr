<x-filament-panels::page>
    ...
    <div style="display: flex; flex-direction: column; gap: 22px;">
        @include('filament.shared.partials.page-hero', [
            ...
            'description' => 'This is the safe sandbox for the new verification builder. We can trial the modern stack, builder flow, and Master Template preview here before touching the live verification form.',
        ...
        <div class="pd-form-lab-phase-grid">
            <section class="pd-form-lab-card">
                <div style="padding: 18px 22px; border-bottom: 1px solid #edf2f7;">
                    ...
                    <div style="margin-top: 8px; font-size: 14px; line-height: 1.7; color: #64748b;">This uses the real clinic template section table, so anything created here becomes available immediately in Question Management and the Master Template workflow.</div>
                </div>
                <div style="padding: 20px 22px; display: grid; gap: 18px;">
            ...
            <section class="pd-form-lab-card">
                <div style="padding: 18px 22px; border-bottom: 1px solid #edf2f7;">
                    ...
                    <h3 style="margin: 8px 0 0; font-size: 22px; font-weight: 800; color: #0f172a;">See the full Master Template structure before placing questions</h3>
                </div>
                <div style="padding: 20px 22px;">
        ...
        <section class="pd-form-lab-card">
            <div style="padding: 18px 22px; border-bottom: 1px solid #edf2f7; display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; flex-wrap: wrap;">
                <div>
                    ...
                    <h3 style="margin: 8px 0 0; font-size: 22px; font-weight: 800; color: #0f172a;">Master Template preview inside the new lab shell</h3>
