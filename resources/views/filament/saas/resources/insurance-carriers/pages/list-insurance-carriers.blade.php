<x-filament-panels::page>
    <x-verification-management-shell
        ...
        menu-description="Configure verification output, insurance master data, question content, and section ordering from one workspace."
    >
                ...
                <div style="padding: 22px 24px; border-bottom: 1px solid #edf2f7; display: flex; align-items: flex-start; justify-content: space-between; gap: 18px; flex-wrap: wrap;">
                    <div>
                        ...
                        <p style="margin: 10px 0 0; max-width: 920px; font-size: 15px; line-height: 1.7; color: #64748b;">
                            Maintain the shared insurance carrier master once here. Clinics inherit these carrier details by default, and local clinic changes stay isolated through clinic-only overrides.
                        </p>
                    </div>
                </div>
