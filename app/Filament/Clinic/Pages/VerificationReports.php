...
class VerificationReports extends Page implements HasForms
{
        ...
        return $schema
            ...
            ->components([
                Section::make('Report Filters')
                    ->description('Filter verification requests for the current clinic, provider mix, outcomes, and team follow-through.')
                    ->schema([
                        Grid::make(4)
                            ->schema([
                                ...
                                Select::make('location_id')
                                    ->label('Location')
                                    ->options(fn (): array => VerificationReport::locationOptions($this->selectedClinicId()))
                                    ->searchable()
                                    ->preload()
                                    ->native(false)
                                    ->live(),
                                Select::make('provider_id')
                                    ->label('Provider')
                                    ->options(fn (): array => VerificationReport::providerOptions($this->selectedClinicId()))
                                    ->searchable()
                                    ->preload()
                                    ->native(false)
                                    ->live(),
        ...
        return [
            ...
            Action::make('downloadCsv')
                ...
                ->action(fn () => response()->streamDownload(
                    ...
                    'clinic-verification-reports.csv',
            ...
            Action::make('downloadExcel')
                ...
                ->action(fn () => response()->streamDownload(
                    ...
                    'clinic-verification-reports.xls',
            ...
            Action::make('downloadWord')
                ...
                ->action(fn () => response()->streamDownload(
                    ...
                    'clinic-verification-reports.doc',
            ...
            Action::make('downloadPdf')
                ...
                ->action(fn () => response()->streamDownload(
                    ...
                    'clinic-verification-reports.pdf',
    ...
    public function getAppliedScopeLabel(): string
    {
        ...
        return $clinic?->clinic_name ?: 'Current clinic';
    }
    ...
    protected function baseQuery(): Builder
    {
        ...
        return VerificationReport::applyFilters($query, $this->form->getState());
    }
    ...
    protected function exportMeta(): array
    {
        ...
        return [
            'title' => 'Clinic Verification Reports',
