...
class DocumentCenter extends Page
{
    ...
    public static function canAccess(): bool
    {
        ...
        return ($user?->canAccessVerificationWorkspace() ?? false)
            && SaasEntitlements::userFeatureAllowed($user, 'document_center', AdminClinicScope::selectedClinic());
    }
    ...
    public function resetFiltersIfNeeded(): void
    {
        // Kept as a Livewire hook target for consistency with other operational pages.
    }
    ...
    {
        return DocumentCenterData::rows('admin', $this->search, $this->typeFilter, $this->dateFilter);
    }
    ...
    {
        return DocumentCenterData::stats('admin');
    }
